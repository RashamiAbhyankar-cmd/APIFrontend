     ...
     */}
      ...
      className="grid-container"> 
        ...
        */}
        ...
        <input className='form-input' type="text" name="strMeal" placeholder={strMeal} value={editdata?.strMeal}
        onChange={e => setEditdata(prev => ({ ...prev, strMeal: e.target.value }))}/>
        
      {/*<input placeholder={recipes[0]?.strCategory} value={recipes[0]?.strCategory || strCategory} onChange={e => setstrCategory(e.target.value)} />*/}

        <input className='form-input' name="strCategory" placeholder={editdata?.strCategory} value={editdata?.strCategory} onChange={e => setEditdata(prev => ({...prev, strCategory:e.target.value}))} />

        <textarea style={{width:'100%'}} className='form-input' placeholder={editdata?.strInstructions} value={editdata?.strInstructions} onChange={e => setEditdata(prev => ({...prev, strInstructions:e.target.value}))}/>

        <input style={{width:'100%', justifySelf:'end'}}className='form-input' placeholder={editdata?.strMealAlternate} value={editdata?.strMealAlternate} onChange={e => setEditdata(prev => ({...prev, strMealAlternate:e.target.value}))} />

        <input className='form-input' placeholder={editdata?.strArea} value={editdata?.strArea} onChange={e => setEditdata(prev => ({...prev, strArea:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMealThumb} value={editdata?.strMealThumb} onChange={e => setEditdata(prev => ({...prev, strMealThumb:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strTags} value={editdata?.strTags} onChange={e => setEditdata(prev => ({...prev, strTags:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strYoutube} value={editdata?.strYoutube} onChange={e => setEditdata(prev => ({...prev, strYoutube:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strSource} value={editdata?.strSource} onChange={e => setEditdata(prev => ({...prev, strSource:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strImageSource} value={editdata?.strImageSource} onChange={e => setEditdata(prev => ({...prev, strImageSource:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strCreativeCommonsConfirmed} value={editdata?.strCreativeCommonsConfirmed} onChange={e => setEditdata(prev => ({...prev, strCreativeCommonsConfirmed:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.dateModified} value={editdata?.dateModified} onChange={e => setEditdata(prev => ({...prev, dateModified:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient1} value={editdata?.strIngredient1} onChange={e => setEditdata(prev => ({...prev, strIngredient1:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure1} value={editdata?.strMeasure1} onChange={e => setEditdata(prev => ({...prev, strMeasure1:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient2} value={editdata?.strIngredient2} onChange={e => setEditdata(prev => ({...prev, strIngredient2:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure2} value={editdata?.strMeasure2} onChange={e => setEditdata(prev => ({...prev, strMeasure2:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient3} value={editdata?.strIngredient3} onChange={e => setEditdata(prev => ({...prev, strIngredient3:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure3} value={editdata?.strMeasure3} onChange={e => setEditdata(prev => ({...prev, strMeasure3:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient4} value={editdata?.strIngredient4} onChange={e => setEditdata(prev => ({...prev, strIngredient4:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure4} value={editdata?.strMeasure4} onChange={e => setEditdata(prev => ({...prev, strMeasure4:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient5} value={editdata?.strIngredient5} onChange={e => setEditdata(prev => ({...prev, strIngredient5:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure5} value={editdata?.strMeasure5} onChange={e => setEditdata(prev => ({...prev, strMeasure5:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient6} value={editdata?.strIngredient6} onChange={e => setEditdata(prev => ({...prev, strIngredient6:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure6} value={editdata?.strMeasure6} onChange={e => setEditdata(prev => ({...prev, strMeasure6:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient7} value={editdata?.strIngredient7} onChange={e => setEditdata(prev => ({...prev, strIngredient7:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure7} value={editdata?.strMeasure7} onChange={e => setEditdata(prev => ({...prev, strMeasure7:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient8} value={editdata?.strIngredient8} onChange={e => setEditdata(prev => ({...prev, strIngredient8:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure8} value={editdata?.strMeasure8} onChange={e => setEditdata(prev => ({...prev, strMeasure8:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient9} value={editdata?.strIngredient9} onChange={e => setEditdata(prev => ({...prev, strIngredient9:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure9} value={editdata?.strMeasure9} onChange={e => setEditdata(prev => ({...prev, strMeasure9:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient10} value={editdata?.strIngredient10} onChange={e => setEditdata(prev => ({...prev, strIngredient10:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure10} value={editdata?.strMeasure10} onChange={e => setEditdata(prev => ({...prev, strMeasure10:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient11} value={editdata?.strIngredient11} onChange={e => setEditdata(prev => ({...prev, strIngredient11:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure11} value={editdata?.strMeasure11} onChange={e => setEditdata(prev => ({...prev, strMeasure11:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient12} value={editdata?.strIngredient12} onChange={e => setEditdata(prev => ({...prev, strIngredient12:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure12} value={editdata?.strMeasure12} onChange={e => setEditdata(prev => ({...prev, strMeasure12:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient13} value={editdata?.strIngredient13} onChange={e => setEditdata(prev => ({...prev, strIngredient13:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure13} value={editdata?.strMeasure13} onChange={e => setEditdata(prev => ({...prev, strMeasure13:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient14} value={editdata?.strIngredient14} onChange={e => setEditdata(prev => ({...prev, strIngredient14:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure14} value={editdata?.strMeasure14} onChange={e => setEditdata(prev => ({...prev, strMeasure14:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient15} value={editdata?.strIngredient15} onChange={e => setEditdata(prev => ({...prev, strIngredient15:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure15} value={editdata?.strMeasure15} onChange={e => setEditdata(prev => ({...prev, strMeasure15:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient16} value={editdata?.strIngredient16} onChange={e => setEditdata(prev => ({...prev, strIngredient16:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure16} value={editdata?.strMeasure16} onChange={e => setEditdata(prev => ({...prev, strMeasure16:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient17} value={editdata?.strIngredient17} onChange={e => setEditdata(prev => ({...prev, strIngredient17:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure17} value={editdata?.strMeasure17} onChange={e => setEditdata(prev => ({...prev, strMeasure17:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient18} value={editdata?.strIngredient18} onChange={e => setEditdata(prev => ({...prev, strIngredient18:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure18} value={editdata?.strMeasure18} onChange={e => setEditdata(prev => ({...prev, strMeasure18:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient19} value={editdata?.strIngredient19} onChange={e => setEditdata(prev => ({...prev, strIngredient19:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure19} value={editdata?.strMeasure19} onChange={e => setEditdata(prev => ({...prev, strMeasure19:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strIngredient20} value={editdata?.strIngredient20} onChange={e => setEditdata(prev => ({...prev, strIngredient20:e.target.value}))} />
        <input className='form-input' placeholder={editdata?.strMeasure20} value={editdata?.strMeasure20} onChange={e => setEditdata(prev => ({...prev, strMeasure20:e.target.value}))} />
